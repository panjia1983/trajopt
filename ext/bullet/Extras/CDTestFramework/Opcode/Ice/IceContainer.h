...
public:
  ...
  {
    return mCurNbEntries;					   //!< Returns the current number of entries.
  }
  inline_	udword			GetMaxNbEntries()				const
  {
    return mMaxNbEntries;					   //!< Returns max number of entries before resizing.
  }
  inline_	udword			GetEntry(udword i)				const
  {
    return mEntries[i];					   //!< Returns ith entry.
  }
  inline_	udword*			GetEntries()					const
  {
    return mEntries;						   //!< Returns the list of entries.
  }
  ...
  {
    return mCurNbEntries == mMaxNbEntries;	   //!< Checks the container is full
  }
  inline_	BOOL			IsNotEmpty()					const
  {
    return mCurNbEntries;					   //!< Checks the container is empty
  }
...
#ifdef CONTAINER_STATS
  static	udword			GetNbContainers()
  {
    return mNbContainers;
  }
  static	udword			GetTotalBytes()
  {
    return mUsedRam;
  }
  static	LinkedList&		GetContainers()
  {
    return mContainers;
  }
private:
