...
inline MatrixC::MatrixC(int r, int c)
{
  data = NULL;
  Resize(c, r);
}
...
inline MatrixC &MatrixC::operator= (unsigned char op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
}
inline MatrixC &MatrixC::operator= (int op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
...
inline MatrixC &MatrixC::Multiply(MatrixF &op)
{
  ...
  if(cols == op.rows)
  {
    ...
    as = data;
    bs = op.data;				// Goto start of A and B matricies
    for(n = newdata ; n < ne;)  				// Compute C = A*B
    {
      a = as;
      b = bs;						// Goto beginning of row in A, top of col in B
      *n = (VTYPE) 0;						// Initialize n element in C
      for(; b < be;)
      {
        *n += (VTYPE)((*a++) * (*b));    // Compute n element in C
        b += bskip;
      }
    ...
    rows = newr;
    cols = newc;
    len = newlen;		// Replace with new A matrix
  }
  return *this;
}
...
inline int MatrixC::GetX()
{
  return cols;
}
inline int MatrixC::GetY()
{
  return rows;
}
inline int MatrixC::GetRows(void)
{
  return rows;
}
inline int MatrixC::GetCols(void)
{
  return cols;
}
inline int MatrixC::GetLength(void)
{
  return len;
}
inline VTYPE *MatrixC::GetData(void)
{
  return data;
}

inline double MatrixC::GetF(int r, int c)
{
  return (double)(*(data + r * cols + c));
}
...
inline MatrixI::MatrixI(int r, int c)
{
  data = NULL;
  Resize(c, r);
}
...
inline MatrixI &MatrixI::operator= (unsigned char op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
}
inline MatrixI &MatrixI::operator= (int op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
}
inline MatrixI &MatrixI::operator= (double op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
...
inline int MatrixI::GetX()
{
  return cols;
}
inline int MatrixI::GetY()
{
  return rows;
}
inline int MatrixI::GetRows(void)
{
  return rows;
}
inline int MatrixI::GetCols(void)
{
  return cols;
}
inline int MatrixI::GetLength(void)
{
  return len;
}
inline VTYPE *MatrixI::GetData(void)
{
  return data;
}

inline double MatrixI::GetF(int r, int c)
{
  return (double)(*(data + r * cols + c));
}
...
inline MatrixF::MatrixF(const int r, const int c)
{
  data = NULL;
  Resize(r, c);
}
...
inline MatrixF &MatrixF::operator= (const unsigned char op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
}
inline MatrixF &MatrixF::operator= (const int op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
}
inline MatrixF &MatrixF::operator= (const double op)
{
  VTYPE *n = data, *nlen = data + len;
  for(; n < nlen;) *n++ = (VTYPE) op;
  return *this;
...
inline int MatrixF::GetX()
{
  return cols;
}
inline int MatrixF::GetY()
{
  return rows;
}
inline int MatrixF::GetRows(void)
{
  return rows;
}
inline int MatrixF::GetCols(void)
{
  return cols;
}
inline int MatrixF::GetLength(void)
{
  return len;
}
inline VTYPE *MatrixF::GetData(void)
{
  return data;
}

inline double MatrixF::GetF(const int r, const int c)
{
  return (double)(*(data + r * cols + c));
}
