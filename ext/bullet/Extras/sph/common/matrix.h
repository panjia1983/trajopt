...
public:
  ...
  virtual Matrix &GaussJordan(MatrixF &b)
  {
    return *this;
  }
  virtual Matrix &ConjugateGradient(MatrixF &b)
  {
    return *this;
  }
...
public:
  ...
  inline unsigned char *GetDataC(void)
  {
    return data;
  }
  inline int *GetDataI(void)
  {
    return NULL;
  }
  inline double *GetDataF(void)
  {
    return NULL;
  }
...
public:
  ...
  inline unsigned char *GetDataC(void) const
  {
    return NULL;
  }
  inline int *GetDataI(void)	const
  {
    return NULL;
  }
  inline double *GetDataF(void) const
  {
    return data;
  }
...
public:
  ...
  // Member Functions
  inline VTYPE &operator()(const int n)
  {
    return data[n];
  }
  inline VTYPE &operator()(const int c, const int r)
  ...
  inline float *GetDataF(void) const
  {
    return (float*) data;
  }
