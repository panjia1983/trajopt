...
template   pcl::PointCloud<pcl::PointXYZ>::Ptr removeOutliers<pcl::PointXYZ>( pcl::PointCloud<pcl::PointXYZ>::ConstPtr in, float thresh, int k);
template   pcl::PointCloud<pcl::PointXYZ>::Ptr getBiggestCluster<pcl::PointXYZ>( pcl::PointCloud<pcl::PointXYZ>::ConstPtr in, float tol);
template   pcl::PointCloud<pcl::PointXYZ>::Ptr clusterFilter<pcl::PointXYZ>( pcl::PointCloud<pcl::PointXYZ>::ConstPtr in, float tol, int minSize);
