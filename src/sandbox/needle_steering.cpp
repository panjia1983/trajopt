...
void TrajPlotter1::OptimizerCallback(OptProb*, DblVec& x, OptStepResults&)
{
...
int main(int argc, char** argv)
{
  ...
  if(plotting)
  {
    ...
    opt.addCallback(boost::bind(&TrajPlotter1::OptimizerCallback, boost::ref(plotter), _1, _2, _3));
  }
